...
this_client_info = {
    ...
    "listen_port": 9031,  #  to listen to other client's command
    "chunk_status": {},
    "downloaded": 0,
    "uploaded": 0
}
send_server_port = 9032  #  to send command to other clients or server
send_client_port = 9033    # to receive data from other
